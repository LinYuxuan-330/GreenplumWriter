    ...
    public void startWrite(RecordReceiver recordReceiver, Configuration writerSliceConfig,
        ...
        try {
            ...
            for (int i = 0; i < numProcessor; i++) {
                cs.submit(new com.alibaba.datax.plugin.writer.greenplumwriter.CopyProcessor(this, this.columnNumber, resultSetMetaData, recordQueue, dataQueue));
            }

            for (int i = 0; i < numWriter; i++) {
                cs.submit(new com.alibaba.datax.plugin.writer.greenplumwriter.CopyWorker(this, sql, dataQueue));
            }
